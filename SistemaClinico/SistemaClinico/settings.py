"""
Django settings for SistemaClinico project.
...
SECRET_KEY = 'django-insecure-nzu2@e72l5e5*4nqhi7m4-*2)5y4nkv5*)pz)n0(6don0zh2my'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['dpg-d48jtffdiees73a06k9g-a']
...
# para desarrollo, indicar donde buscar archivos estaticos en cada app
STATICFILES_DIRS = [
    BASE_DIR / "static"
]
